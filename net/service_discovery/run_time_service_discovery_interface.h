//
// Created for KaiRPC on 23-10-21.
//
...
public:
    ...
    RC_Message heartbeat_service(std::string service_name, std::string ip, int port) {
        std::string command = "heartbeat" + std::string(" ") + service_name +
